...
'cookie_pre' => 'CMSE61B1497FD094_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'js_path' => 'http://localhost:82/statics/js/', //CDN JS
'css_path' => 'http://localhost:82/statics/css/', //CDN CSS
'img_path' => 'http://localhost:82/statics/images/', //CDN img
'mobile_js_path' => 'http://localhost:82/mobile/statics/js/', //CDN JS
'mobile_css_path' => 'http://localhost:82/mobile/statics/css/', //CDN CSS
'mobile_img_path' => 'http://localhost:82/mobile/statics/images/', //CDN img
'app_path' => 'http://localhost:82/', //动态域名配置地址
'mobile_path' => 'http://localhost:82/mobile/', //动态手机域名配置地址
'bdmap_api' => '', //百度地图API
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'CMS2abfa26e273617cecb18752ef6b4fb00', //安全密匙
'lang' => 'zh-cn', //网站语言包
