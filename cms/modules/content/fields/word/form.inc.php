	function word($field, $value, $fieldinfo) {
		...
		//if (defined('IS_ADMIN') && IS_ADMIN) {
			return '<input type="hidden" name="info['.$field.']" id="'.$field.'_word" value="'.$value.'"><button type="button" class="layui-btn layui-btn-sm" id="'.$field.'"><i class="layui-icon">&#xe67c;</i>'.L('import_word').'</button>'.$str;
		//} else {
