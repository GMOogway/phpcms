...
<table cellpadding="2" cellspacing="1" width="98%">
	...
	<tr> 
      <td>默认值</td>
      <td><textarea name="setting[defaultvalue]" rows="2" cols="20" id="defaultvalue" style="height:60px;width:200px;" ><?php echo new_html_special_chars($setting['defaultvalue']);?></textarea></td>
    </tr>
	<tr> 
      <td>是否允许Html</td>
