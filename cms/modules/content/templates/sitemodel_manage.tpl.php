...
<div class="table-list">
    ...
    <tr>
        ...
        <td align='center'><a class="btn btn-xs blue" href="?m=content&c=sitemodel_field&a=init&modelid=<?php echo $r['modelid']?>&menuid=<?php echo $this->input->get('menuid');?>"><?php echo L('field_manage');?></a><a class="btn btn-xs green" href="?m=content&c=sitemodel&a=edit&modelid=<?php echo $r['modelid']?>&menuid=<?php echo $this->input->get('menuid');?>"><?php echo L('edit');?></a><a class="btn btn-xs dark" href="?m=content&c=sitemodel&a=disabled&modelid=<?php echo $r['modelid']?>&menuid=<?php echo $this->input->get('menuid');?>"><?php echo $r['disabled'] ? L('field_enabled') : L('field_disabled');?></a><a class="btn btn-xs red" href="javascript:;" onclick="model_delete(this,'<?php echo $r['modelid']?>','<?php echo L('confirm_delete_model',array('message'=>new_addslashes($tablename)));?>','<?php echo $r['items']?>')"><?php echo L('delete')?></a><a class="btn btn-xs yellow" href="?m=content&c=sitemodel&a=export&modelid=<?php echo $r['modelid']?>&menuid=<?php echo $this->input->get('menuid');?>"><?php echo L('export');?></a></td>
    </tr>
    <?php } ?>
    </tbody>
    </table>
