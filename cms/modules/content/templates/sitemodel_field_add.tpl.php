...
<?php echo form::select($all_field,'','name="info[formtype]" id="formtype" onchange="javascript:field_setting(this.value);"',L('select_fieldtype'));?>
	...
	<tr> 
      ...
      <td><input type="text" name="info[name]" id="name" size="30" class="input-text" onblur="topinyin('field','name','?m=content&c=sitemodel_field&a=public_ajax_pinyin');"></td>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><textarea name="info[tips]" rows="2" cols="20" id="tips" style="height:128px; width:80%"></textarea></td>
    </tr>
