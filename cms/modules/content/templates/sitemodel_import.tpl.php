...
<fieldset>
  ...
  <tr>
		...
		<td>
		<label><input type="text" class='input-text' id="myfile" name="myfile" size="26" readonly="readonly"></label> <label><span class="btn green btn-sm fileinput-button"><i class="fa fa-cloud-upload"></i> <span> <?php echo L('select_file');?> </span> <input type="file" name="model_import" id="model_import" onchange="myfile.value=this.value"></span></label>
		</td>
	</tr>
</table>
</fieldset>
