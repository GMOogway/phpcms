...
pc_base::load_sys_class('format', 'member', 0);
pc_base::load_sys_class('form', 'member', 0);
...
class member extends foreground {
	...
	public function init() {
		...
		include template('fclient', 'index');
	}
