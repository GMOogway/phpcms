...
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		...
		<td><input type="text" name="fclient[inputtime]" id="fclient_inputtime" value="<?php if ($inputtime) echo date('Y-m-d',$inputtime);?>" size="30" class="date"><button class="button" type="button" onclick="dr_to_clear('fclient_inputtime')"><?php echo L('clear')?></button><script type="text/javascript">
			Calendar.setup({
			weekNumbers: true,
	...
	<tr>
		...
		<td><input type="text" name="fclient[endtime]" id="fclient_endtime" value="<?php if ($endtime) echo date('Y-m-d',$endtime);?>" size="30" class="date"><button class="button" type="button" onclick="dr_to_clear('fclient_endtime')"><?php echo L('clear')?></button><script type="text/javascript">
			Calendar.setup({
			weekNumbers: true,
