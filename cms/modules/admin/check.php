...
class check extends admin {
    ...
    public function public_do_index() {
        ...
        \'autoconnect\' => '.$my['autoconnect'].'
                ...
                $menu = $this->db->get_one(array('name' => 'site_field_manage', 'parentid' => 10, 'm' => 'content', 'c' => 'sitemodel_field', 'a' => 'init', 'data' => '&modelid=0'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'site_field_manage\', 10, \'content\', \'sitemodel_field\', \'init\', \'&modelid=0\', \'fa-puzzle-piece\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'category_field_manage', 'parentid' => 141, 'm' => 'content', 'c' => 'sitemodel_field', 'a' => 'init', 'data' => '&modelid=-1'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'category_field_manage\', 141, \'content\', \'sitemodel_field\', \'init\', \'&modelid=-1\', \'fa fa-code\', 7, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'page_field_manage', 'parentid' => 141, 'm' => 'content', 'c' => 'sitemodel_field', 'a' => 'init', 'data' => '&modelid=-2'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'page_field_manage\', 141, \'content\', \'sitemodel_field\', \'init\', \'&modelid=-2\', \'fa-list\', 8, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'recycle', 'parentid' => 72, 'm' => 'content', 'c' => 'content', 'a' => 'recycle_init'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'recycle\', 72, \'content\', \'content\', \'recycle_init\', \'\', \'fa fa-trash-o\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'restore', 'parentid' => 72, 'm' => 'content', 'c' => 'content', 'a' => 'recycle'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'restore\', 72, \'content\', \'content\', \'recycle\', \'\', \'fa fa-reply\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'update', 'parentid' => 72, 'm' => 'content', 'c' => 'content', 'a' => 'update'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'update\', 72, \'content\', \'content\', \'update\', \'\', \'fa fa-refresh\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'content_all', 'parentid' => 72, 'm' => 'content', 'c' => 'content', 'a' => 'initall'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'content_all\', 72, \'content\', \'content\', \'initall\', \'\', \'fa fa-th-large\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'create_all', 'parentid' => 130, 'm' => 'content', 'c' => 'create_all_html', 'a' => 'all_update'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'create_all\', 130, \'content\', \'create_all_html\', \'all_update\', \'\', \'fa fa-file-code-o\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'public_error', 'parentid' => 226, 'm' => 'admin', 'c' => 'index', 'a' => 'public_error'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'public_error\', 226, \'admin\', \'index\', \'public_error\', \'\', \'fa fa-shield\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'public_error_log', 'parentid' => 226, 'm' => 'admin', 'c' => 'index', 'a' => 'public_error_log'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'public_error_log\', 226, \'admin\', \'index\', \'public_error_log\', \'\', \'fa fa-shield\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'public_email_log', 'parentid' => 226, 'm' => 'admin', 'c' => 'index', 'a' => 'public_email_log'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'public_email_log\', 226, \'admin\', \'index\', \'public_email_log\', \'\', \'fa fa-envelope-open\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'attachment', 'parentid' => 8, 'm' => 'attachment', 'c' => 'attachment', 'a' => 'init'));
                if (!$menu) {
                    $parentid = $this->db->insert(array('name'=>'attachment', 'parentid'=>8, 'm'=>'attachment', 'c'=>'attachment', 'a'=>'init', 'data'=>'', 'icon'=>'fa fa-folder', 'listorder'=>3, 'display'=>'1'), true);
                } else {
                    $parentid = $menu['id'];
                }
                ...
                $menu = $this->db->get_one(array('name' => 'check_bom', 'parentid' => 226, 'm' => 'admin', 'c' => 'check_bom', 'a' => 'init'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'check_bom\', 226, \'admin\', \'check_bom\', \'init\', \'\', \'fa fa-code\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
                $menu = $this->db->get_one(array('name' => 'check', 'parentid' => 226, 'm' => 'admin', 'c' => 'check', 'a' => 'init'));
                if (!$menu) {
                    $this->db->query('INSERT INTO `'.$this->db->table_name.'` (`name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES (\'check\', 226, \'admin\', \'check\', \'init\', \'\', \'fa fa-wrench\', 0, \'1\', 1, 1, 1, 1, 1);');
                }
...
\'sys_attachment_cf\' => '.(pc_base::load_config('system','sys_attachment_cf') ? pc_base::load_config('system','sys_attachment_cf') : 0).', //重复上传控制
...
\'sys_admin_pagesize\' => \''.(pc_base::load_config('system','sys_admin_pagesize') ? pc_base::load_config('system','sys_admin_pagesize') : 10).'\', //后台数据分页显示数量
