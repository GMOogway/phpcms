...
class check extends admin {
    ...
    public function public_do_index() {
        ...
        \'autoconnect\' => '.$my['autoconnect'].'
                ...
                if (!$content_field) {
                    $this->db->insert(array('modelid' => -2, 'siteid' => 1, 'field' => 'content', 'name' => '内容', 'tips' => '', 'css' => '', 'minlength' => 1, 'maxlength' => '999999', 'pattern' => '', 'errortips' => '内容不能为空', 'formtype' => 'editor', 'setting' => '{"width":"","height":"","toolbar":"full","toolvalue":"\'Bold\', \'Italic\', \'Underline\'","defaultvalue":"","enablekeylink":"1","replacenum":"2","link_mode":"0","enablesaveimage":"0","show_bottom_boot":"1","tool_select_1":"0","tool_select_2":"0","tool_select_3":"1","tool_select_4":"1","color":"","theme":"default","autofloat":"0","div2p":"1","autoheight":"0","enter":"0","watermark":"1","attachment":"0","image_reduce":"","allowupload":"0","upload_number":"","upload_maxsize":"","local_img":"1","local_watermark":"1","local_attachment":"0","local_image_reduce":"","disabled_page":"1"}', 'formattribute' => '', 'unsetgroupids' => '', 'unsetroleids' => '', 'iscore' => 0, 'issystem' => 1, 'isunique' => 0, 'isbase' => 1, 'issearch' => 0, 'isadd' => 0, 'isfulltext' => 0, 'isposition' => 0, 'listorder' => 0, 'disabled' => 0, 'isomnipotent' => 0));
                }
...
\'sys_csrf_time\' => \''.(pc_base::load_config('system','sys_csrf_time') ? pc_base::load_config('system','sys_csrf_time') : 0).'\', //CSRF验证有效期
...
\'admin_login_path\' => \''.pc_base::load_config('system','admin_login_path').'\', //自定义的后台登录地址';
                ...
                if (!strstr($system, 'IN_CMS') || strstr($system, 'admin_url') || strstr($system, 'safe_card') || strstr($system, 'phpsso') || strstr($system, 'phpsso_appid') || strstr($system, 'phpsso_api_url') || strstr($system, 'phpsso_auth_key') || strstr($system, 'phpsso_version') || strstr($system, '\'timezone\' => \'Etc/GMT-8\'') || strstr($system, 'lock_ex') || strstr($system, 'snda_akey') || strstr($system, 'snda_skey') || strstr($system, 'qq_akey') || strstr($system, 'qq_skey') || !strstr($system, 'sys_time_format') || !strstr($system, 'attachment_file') || !strstr($system, 'attachment_del') || !strstr($system, 'sys_attachment_save_id') || !strstr($system, 'sys_attachment_cf') || !strstr($system, 'sys_attachment_safe') || !strstr($system, 'sys_attachment_path') || !strstr($system, 'sys_attachment_save_type') || !strstr($system, 'sys_attachment_save_dir') || !strstr($system, 'sys_attachment_url') || !strstr($system, 'sys_avatar_path') || !strstr($system, 'sys_avatar_url') || !strstr($system, 'sys_thumb_path') || !strstr($system, 'sys_thumb_url') || !strstr($system, 'mobile_js_path') || !strstr($system, 'mobile_css_path') || !strstr($system, 'mobile_img_path') || !strstr($system, 'mobile_path') || !strstr($system, 'bdmap_api') || !strstr($system, 'sys_editor') || !strstr($system, 'sys_admin_pagesize') || !strstr($system, 'sys_csrf') || !strstr($system, 'sys_csrf_time') || !strstr($system, 'needcheckcomeurl') || !strstr($system, 'mobile_root') || !strstr($system, 'keywordapi') || !strstr($system, 'baidu_aid') || !strstr($system, 'baidu_skey') || !strstr($system, 'baidu_arcretkey') || !strstr($system, 'baidu_qcnum') || !strstr($system, 'xunfei_aid') || !strstr($system, 'xunfei_skey') || !strstr($system, 'admin_login_path')) {
