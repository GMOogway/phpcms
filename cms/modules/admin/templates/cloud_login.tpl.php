                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-7">
                            <button type="button" onclick="dr_post_submit('?m=admin&c=cloud&a=license&menuid=<?php echo $this->input->get('menuid')?>', 'myform', 3000, '?m=admin&c=cloud&a=init&menuid=<?php echo $this->input->get('menuid')?>&pc_hash=<?php echo $_SESSION['pc_hash']?>');" class="btn red " style="margin-right: 20px;"> 绑定账号 </button>
