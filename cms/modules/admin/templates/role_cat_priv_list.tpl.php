...
<table width="100%">
			  <thead>
				<tr>
				  <th width="60"><?php echo L('select_all')?></th><th align="left"><?php echo L('title_varchar')?></th><th width="60"><?php echo L('view')?></th><th width="60"><?php echo L('add')?></th><th width="60"><?php echo L('edit')?></th><th width="60"><?php echo L('delete')?></th><th width="60"><?php echo L('sort')?></th><th width="60"><?php echo L('push')?></th><th width="60"><?php echo L('move')?></th><th width="60"><?php echo L('copy')?></th><th width="60"><?php echo L('recycle')?></th><th width="60"><?php echo L('restore')?></th><th width="60"><?php echo L('update')?></th>
			  </tr>
			    </thead>
				 <tbody>
				<?php echo $categorys?>
