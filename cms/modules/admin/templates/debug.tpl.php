...
<div id="think_page_trace" style="position: fixed;bottom:0;right:0;font-size:14px;width:100%;z-index: 10001; color: #000;text-align:left;font-family:'微软雅黑';">
    <div id="think_page_trace_tab" style="display: none;background:white;margin:0;height: 250px;">
        ...
        <div id="think_page_trace_tab_tit" style="height:32px;padding:0px 12px;border-bottom:1px solid #ececec;border-top:1px solid #ececec;font-size:16px; background: #efefef;">
