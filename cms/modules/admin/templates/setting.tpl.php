  ...
  <tr>
    ...
    <td class="y-bg">
	  <div class="mt-radio-inline">
          ...
          <label class="mt-radio mt-radio-outline"><input name="setting[sysadmincode]" value="1" type="radio" <?php echo ($sysadmincode) ? ' checked' : ''?> onclick="$('#sysadmincodemodel').hide();$('#captcha_charset').hide();$('#sysadmincodevoicemodel').hide();"> <?php echo L('setting_no')?> <span></span></label>
        </div>
     </td>
  </tr> 
  <tr id="sysadmincodemodel"<?php echo ($sysadmincode) ? ' style="display: none;"' : ''?>>
    ...
    <td class="y-bg">
	  <div class="mt-radio-inline">
          ...
          <label class="mt-radio mt-radio-outline"><input name="setting[sysadmincodemodel]" value="1" type="radio" <?php echo ($sysadmincodemodel==1) ? ' checked' : ''?> onclick="$('#captcha_charset').hide();$('#sysadmincodevoicemodel').hide();"> <?php echo L('setting_digital')?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input name="setting[sysadmincodemodel]" value="2" type="radio" <?php echo ($sysadmincodemodel==2) ? ' checked' : ''?> onclick="$('#captcha_charset').hide();$('#sysadmincodevoicemodel').show();"> <?php echo L('setting_letters')?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input name="setting[sysadmincodemodel]" value="3" type="radio" <?php echo ($sysadmincodemodel==3) ? ' checked' : ''?> onclick="$('#captcha_charset').show();$('#sysadmincodevoicemodel').hide();"> <?php echo L('setting_character')?> <span></span></label>
        </div>
     </td>
  </tr> 
