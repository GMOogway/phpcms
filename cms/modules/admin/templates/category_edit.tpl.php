    ...
    <div class="portlet-title tabbable-line">
        <ul class="nav nav-tabs" style="float:left;">
            ...
            <li<?php if ($page==5) {?> class="active"<?php }?>>
                <a data-toggle="tab_5" onclick="$('#dr_page').val('5')"<?php if (is_mobile(0)) {echo ' onmouseover="layer.tips(\''.L('catgory_readpoint').'\',this,{tips: [1, \'#000\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-rmb"></i> <?php if (!is_mobile(0)) {echo L('catgory_readpoint');}?> </a>
            </li>
            <li<?php if ($page==6) {?> class="active"<?php }?>>
                <a data-toggle="tab_6" onclick="$('#dr_page').val('6')"<?php if (is_mobile(0)) {echo ' onmouseover="layer.tips(\''.L('field_manage').'\',this,{tips: [1, \'#000\']});" onmouseout="layer.closeAll();"';}?>> <i class="fa fa-code"></i> <?php if (!is_mobile(0)) {echo L('field_manage');}?> </a>
            </li>
        </ul>
    </div>
    <div class="portlet-body form">
		...
		?></label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="info[description]" maxlength="255" style="height:90px;"><?php echo $description;?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
	...
	?></label>
            ...
            <div class="tab-pane<?php if ($page==2) {?> active<?php }?>" id="tab_2">
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label">电脑列表信息数</label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label><input class="form-control" type="text" value="<?php echo $setting['mpagesize'];?>" name="setting[mpagesize]"></label>
                            <span class="help-block">请与模板调用数量相同，静态生成时调用此参数</span>
                        </div>
                    </div>
                        ...
                        <div class="col-md-9">
                            <div class="user_group J_check_wrap">
                                <dl>
                                    ...
                                    <dd>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('init',$roleid);?> value="init,<?php echo $roleid;?>" ><?php echo L('view');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('add',$roleid);?> value="add,<?php echo $roleid;?>" ><?php echo L('add');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('edit',$roleid);?> value="edit,<?php echo $roleid;?>" ><?php echo L('edit');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('delete',$roleid);?> value="delete,<?php echo $roleid;?>" ><?php echo L('delete');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('listorder',$roleid);?> value="listorder,<?php echo $roleid;?>" ><?php echo L('listorder');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('push',$roleid);?> value="push,<?php echo $roleid;?>" ><?php echo L('push');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('remove',$roleid);?> value="remove,<?php echo $roleid;?>" ><?php echo L('move');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('copy',$roleid);?> value="copy,<?php echo $roleid;?>" ><?php echo L('copy');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('recycle_init',$roleid);?> value="recycle_init,<?php echo $roleid;?>" ><?php echo L('recycle');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('recycle',$roleid);?> value="recycle,<?php echo $roleid;?>" ><?php echo L('restore');?><span></span></label>
                                        <label class="mt-checkbox mt-checkbox-outline"><input class="J_check" type="checkbox" data-yid="J_check_priv_roleid<?php echo $roleid;?>" name="priv_roleid[]" <?php echo $disabled;?> <?php echo $this->check_category_priv('update',$roleid);?> value="update,<?php echo $roleid;?>" ><?php echo L('update');?><span></span></label>
                                    </dd>
                                    <?php }?>
                                </dl>
                            </div>
