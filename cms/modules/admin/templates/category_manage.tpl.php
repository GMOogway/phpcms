    ...
    <form class="form-horizontal" role="form" id="myform">
        ...
        <div class="row list-footer table-checkable ">
            <div class="col-md-12 list-select">
                ...
                <label><button type="button" onclick="ajax_option('?m=admin&c=category&a=delete&pc_hash='+pc_hash, '<?php echo L('你确定要删除它们吗？');?>', 1)" class="btn red btn-sm"> <i class="fa fa-trash"></i> <?php echo L('delete');?></button></label>
