...
<?php } else {?>
未绑定平台账户，请点击<a class="btn btn-xs blue" href="<?php echo SELF;?>?m=sms&c=sms&a=sms_setting&menuid=<?php echo $this->input->get('menuid');?>&pc_hash=<?php echo $_GET['pc_hash'];?>">平台设置</a>绑定。
<?php }?>
</div><br>
