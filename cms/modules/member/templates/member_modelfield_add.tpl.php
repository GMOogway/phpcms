...
<input name="info[modelid]" type="hidden" value="<?php echo $modelid;?>">
    ...
    <div class="portlet-body form myfooter">
        <div class="form-actions text-center">
            <button type="button" id="my_submit" onclick="dr_ajax_submit('?m=member&c=member_modelfield&a=add&page='+$('#dr_page').val(), 'myform', '2000')" class="btn green"> <i class="fa fa-save"></i> <?php echo L('submit')?></button>
        </div>
    </div>
</form>
</div>
