...
<div class="subnav">
    <div class="content-menu ib-a">
        <a href="?m=member&c=member_modelfield&a=manage&modelid=<?php echo $modelid?>&menuid=<?php echo $this->input->get('menuid')?>"> <i class="fa fa-reorder"></i> <?php echo L('会员模型字段管理');?></a>
        <i class="fa fa-circle"></i>
        <a href="?m=member&c=member_modelfield&a=add&modelid=<?php echo $modelid?>&menuid=<?php echo $this->input->get('menuid')?>"> <i class="fa fa-plus"></i> <?php echo L('添加模型字段');?></a>
        <i class="fa fa-circle"></i>
        <a href="<?php echo dr_now_url();?>" class="on"> <i class="fa fa-edit"></i> <?php echo L('修改模型字段');?></a>
    </div>
</div>
