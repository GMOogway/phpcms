...
<div class="subnav">
    ...
    <?php echo admin::submenu($this->input->get('menuid'),$big_menu); ?><a href="javascript:artdialog('setting','?m=poster&c=space&a=setting','<?php echo L('module_setting')?>',540,320);void(0);"><i class="iconm fa fa-cog"></i> <?php echo L('module_setting')?></a>
    </div>
    <?php }?>
</div>
