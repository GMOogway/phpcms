            ...
            <div class="tab-pane<?php if ($page==0) {?> active<?php }?>" id="tab_0">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control input-large" type="text" id="title" name="special[title]" value="" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" id="file_div">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="special[filename]" id="filename" class="form-control input-large" value="<?php echo $info['filename']?>">
