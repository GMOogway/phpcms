...
<input name="oldfield" type="hidden" value="<?php echo $field?>">
                ...
                <div class="tab-pane<?php if ($page==0) {?> active<?php }?>" id="tab_0">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" id="dr_row_name">
                            ...
                            <div class="col-md-9">
                                <label><input class="form-control" type="text" name="info[name]" value="<?php echo $name?>" id="name" onblur="topinyin('field','name','?m=content&c=sitemodel_field&a=public_ajax_pinyin');"></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <label><input class="form-control" type="text" name="info[field]" value="<?php echo $field?>" <?php if(dr_in_array($field,$forbid_delete)) echo 'readonly';?> id="field"></label>
    ...
    <div class="portlet-body form myfooter">
        <div class="form-actions text-center">
            <button type="button" id="my_submit" onclick="dr_ajax_submit('?m=formguide&c=formguide_field&a=edit&page='+$('#dr_page').val(), 'myform', '2000')" class="btn green"> <i class="fa fa-save"></i> <?php echo L('submit')?></button>
        </div>
    </div>
</form>
</div>
