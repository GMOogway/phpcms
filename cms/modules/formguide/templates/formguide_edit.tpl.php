...
<tbody>
	<tr>
		...
		<td><input name="info[name]" id="name" class="input-text" type="text" value="<?php echo new_html_special_chars($data['name'])?>" size="30" onblur="topinyin('tablename','name','?m=formguide&c=formguide&a=public_ajax_pinyin');"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><div class="mt-radio-inline">
          <label class="mt-radio mt-radio-outline"><input type='radio' name='setting[code]' value='1' <?php if($data['setting']['code'] == 1) {?>checked<?php }?>> <?php echo L('yes')?> <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type='radio' name='setting[code]' value='0' <?php if($data['setting']['code'] == 0) {?>checked<?php }?>> <?php echo L('no')?> <span></span></label>
        </div></td>
	</tr>
	<tr>
