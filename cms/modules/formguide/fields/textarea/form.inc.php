	function textarea($field, $value, $fieldinfo) {
		...
		return "<textarea name='info[{$field}]' id='$field' style='width:{$width}".(is_numeric($width) ? 'px' : '').";height:{$height}px;' $formattribute $css $this->no_allowed>".code2html($value)."</textarea>";
	}
