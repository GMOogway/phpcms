	function editor($field, $value, $fieldinfo) {
		...
		return "<div id='{$field}_tip'></div>".'<textarea class="dr_ueditor dr_ueditor_'.$field.'" name="info['.$field.']" id="'.$field.'" boxid="'.$field.'">'.$value.'</textarea>'.form::editor($field,$toolbar,'formguide','',$color,$allowupload,1,'',$height,0,$upload_number,$this->formid,$toolvalue,$autofloat,$autoheight,$theme,$language,$watermark,$attachment,$image_reduce,$chunk,$div2p,$enter,$enablesaveimage,$width,$upload_maxsize);
	}
