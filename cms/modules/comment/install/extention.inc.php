...
$parentid = $menu_db->insert(array('name'=>'comment', 'parentid'=>'42', 'm'=>'comment', 'c'=>'comment_admin', 'a'=>'init', 'data'=>'', 'icon'=>'fa fa-comments', 'listorder'=>0, 'display'=>'1'), true);
$mid = $menu_db->insert(array('name'=>'comment_manage', 'parentid'=>'71', 'm'=>'comment', 'c'=>'comment_admin', 'a'=>'listinfo', 'data'=>'', 'icon'=>'fa fa-comments', 'listorder'=>0, 'display'=>'1'), true);
