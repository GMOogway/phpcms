...
QQ、微信：297885395，254191016，168412248，771357061 QQ讨论群：551419699 联系电话：17684313488

#### PHPCMS V10 插件：
1. PHPCMS V10远程附件：七牛云存储、百度云存储、FTP存储、腾讯云存储、阿里云存储，远程附件只是第三方存储方案，远程附件单个150元，打包购买价500元。
2. PHPCMS V10 短信平台阿里云短信和腾讯云短信双平台单个180元/个，打包购买价300元。
3. PHPCMS V10 Excel导入与导出插件800元/个。
4. PHPCMS V10 火车头采集（支持蓝天采集器）500元/个。
5. 原版V9数据转换PHPCMS V10，500元/个。
6. 织梦DEDECMS数据转换PHPCMS V10，500元/个。
7. 易优EyouCMS数据转换PHPCMS V10，500元/个。
8. PbootCMS数据转换PHPCMS V10，500元/个。
...
### 升级为CK4.20.0编辑器
![](http://ceshi.kaixin100.cn/upload/images/ckeditor.png "升级为CK4.20.0编辑器")
### 升级为Ueditor编辑器
