...
#### PHPCMS V10插件：
QQ、微信：297885395，254191016，168412248，771357061 QQ讨论群：551419699 联系电话：17684313488
PHPCMS V10远程附件：七牛云存储、百度云存储、FTP存储、腾讯云存储、阿里云存储，远程附件只是第三方存储方案，远程附件单个150元，打包购买价500元。
PHPCMS V10 短信平台阿里云短信和腾讯云短信双平台单个180元/个，打包购买价300元。
PHPCMS V10 Excel导入与导出插件800元/个。
PHPCMS V10 火车头采集（支持蓝天采集器）500元/个。
以前原版V9数据转换PHPCMS V10，300元/个。
织梦DEDECMS数据转换PHPCMS V10，300元/个。
易优EyouCMS数据转换PHPCMS V10，300元/个。
