            ...
            <div class="clr">
                ...
                <div class="ct_box nobrd set7s">
                    <div class="nr">
                        ...
                        <div class="clj">
                            <ul>
                                <li><a href="<?php echo FC_NOW_HOST.(pc_base::load_config('system','admin_login_path') ? pc_base::load_config('system','admin_login_path') : 'admin.php')?>" class="btn btn-success">后台管理</a></li>
                            </ul>
                        </div>                    
                        <div class="txt_c">
                        <?php if(pc_base::load_config('system','admin_login_path')){ ?>
                        <div class="warmtips">温馨提示：请将以下后台登录入口添加到你的收藏夹，为了你的安全，不要泄漏或发送给他人！如有泄漏请及时修改！<a href="<?php echo FC_NOW_HOST.pc_base::load_config('system','admin_login_path')?>"><?php echo FC_NOW_HOST.pc_base::load_config('system','admin_login_path')?></a></div>
                        <?php }?>
