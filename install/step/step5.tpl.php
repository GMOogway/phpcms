                                ...
                                <div class="content">
                                    <table width="100%" cellspacing="1" cellpadding="0">
                                        <tr>
                                            ...
                                            <td><input name="adminpath" id="adminpath" type="text" placeholder="设置后台登录地址" value="" class="input-text" /><button class="btn btn-sm blue" type="button" name="button" onclick="to_key()"> 自动生成 </button><br>后台登录地址设置同文件夹命名规则，可为空，为空不更改后台地址，例如:admin 安装完成后后台登录地址即为 <?php echo FC_NOW_HOST.substr($rootpath, 1);?>admin</td>
                                        </tr>
                                        <tr>
