...
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('145', 'category_cache', '140', 'admin', 'category', 'show:public_repair,500,300', 'module=admin', 'fa fa-globe', '0', '0');
