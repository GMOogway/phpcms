...
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`, `project1`, `project2`, `project3`, `project4`, `project5`) VALUES('144', 'add_page', '141', 'admin', 'category', 'add:add,80%,80%', 's=1', 'fa fa-plus-square', '0', '1', '1', '1', '1', '1', '1');
