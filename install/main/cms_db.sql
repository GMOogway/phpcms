...
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('167', 'manage_member', '166', 'member', 'member', 'init', '', 'fa fa-user', '0', '1');
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('168', 'member_manage', '167', 'member', 'member', 'init', '', 'fa fa-user', '0', '1');
...
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('177', 'member_verify', '167', 'member', 'member_verify', 'init', 's=0', 'fa fa-check-square-o', '0', '1');
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('178', 'verify_pass', '177', 'member', 'member_verify', 'init', 's=1', 'fa fa-th-list', '0', '1');
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('179', 'verify_ignore', '177', 'member', 'member_verify', 'init', 's=2', 'fa fa-list-alt', '0', '1');
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('180', 'verify_delete', '177', 'member', 'member_verify', 'init', 's=3', 'fa fa-trash-o', '0', '0');
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('181', 'verify_deny', '177', 'member', 'member_verify', 'init', 's=4', 'fa fa-list', '0', '1');
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('182', 'never_pass', '177', 'member', 'member_verify', 'init', 's=5', 'fa fa-ban', '0', '1');
...
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('189', 'manage_member_group', '166', 'member', 'member_group', 'init', '', 'fa fa-users', '0', '1');
INSERT INTO `cms_menu` (`id`, `name`, `parentid`, `m`, `c`, `a`, `data`, `icon`, `listorder`, `display`) VALUES('190', 'member_group_manage', '189', 'member', 'member_group', 'init', '', 'fa fa-users', '0', '1');
