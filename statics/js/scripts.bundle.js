...
var KTLayoutSearch = function() {
    ...
    return {
        init: function() { (e = document.querySelector("#kt_header_search")) && (i = e.querySelector('[data-kt-search-element="wrapper"]'),
                (m = new KTSearch(e)).on("kt.search.process", f), m.on("kt.search.clear", p)
